...
const bd_juego = [
  {
      id:'A',
      pregunta:"Escribir el equivalente de 128 en binario",
      respuesta:"10000000"
  },
  {
    id:'B',
    pregunta:"Cuál es el máximo número en decimal de un octeto",
    respuesta:"255"
  },
  {
    id:'C',
...
//Creamos el circulo con las letras de la A a la Z
...
recomenzar.addEventListener("click", function(event) {
  ...
  document.getElementById("no-pasar-nivel").style.display = "none";
  document.getElementById("pasar-nivel").style.display = "none";
  document.getElementById("pantalla-juego").style.display = "block";
  largarTiempo();
  cargarPregunta();
});